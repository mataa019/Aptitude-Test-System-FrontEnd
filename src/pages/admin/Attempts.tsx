...
import { getAllTestTemplates, getPendingReviewAttempts } from '../../api/admin';
...
export const Attempts: React.FC<AttemptsProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'pending' | 'by-template'>('pending');
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                {pendingLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">All submitted attempts have been reviewed!</p>
                  </div>
                ) : (
